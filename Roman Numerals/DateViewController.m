...
- (void)viewDidLoad
{
    ...
    NSMutableDictionary *itemTwo = [@{ kTitleKey : @"Date",
                                       ...
                                       kModeKey : [NSNumber numberWithInteger:UIDatePickerModeDate] } mutableCopy];
    NSMutableDictionary *itemThree = [@{ kTitleKey : @"Date & Time",
                                         kDateKey : [NSDate date],
                                         kModeKey : [NSNumber numberWithInteger:UIDatePickerModeDateAndTime]} mutableCopy];
    NSMutableDictionary *itemFour = [@{ kTitleKey : @"Time",
                                         kDateKey : [NSDate date],
                                        kModeKey : [NSNumber numberWithInteger:UIDatePickerModeTime]} mutableCopy];
    NSMutableDictionary *itemFive = [@{ kTitleKey : @"Day & Month",
